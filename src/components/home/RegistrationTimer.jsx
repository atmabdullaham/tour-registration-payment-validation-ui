...
const RegistrationTimer = () => {
  const [enrollmentEnd] = useState(new Date("2026-06-14T23:59:59"));
  ...
  return (
    <div className="relative w-full overflow-hidden bg-brand-light/30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-stretch md:w-10/12 mx-auto py-10 md:py-20 h-full gap-8">
        {/* Poster Info Section */}
        <div className="w-full h-full flex flex-col justify-center pb-4 md:pb-0 px-4">
          <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-brand-primary">
            <h3 className="text-brand-secondary text-lg font-bold tracking-widest uppercase mb-1">The Next Chapter</h3>
            <h1 className="text-3xl md:text-5xl font-black text-brand-primary mb-6">Beyond SSC'26</h1>
            
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                <div className="mt-1 bg-brand-accent/10 p-2 rounded-full">
                  <svg className="w-5 h-5 text-brand-accent" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"></path></svg>
                </div>
                <div>
                  <h4 className="font-bold text-gray-800">Venue:</h4>
                  <p className="text-gray-600">Foy's Lake Concord Amusement World</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="mt-1 bg-brand-secondary/10 p-2 rounded-full">
                  <svg className="w-5 h-5 text-brand-secondary" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"></path></svg>
                </div>
                <div>
                  <h4 className="font-bold text-gray-800">Date & Time:</h4>
                  <p className="text-gray-600">16th JUNE 2026, Reporting Time: 2.30 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-brand-primary text-white p-4 rounded-xl flex justify-between items-center mb-6">
              ...
              <div className="text-right">
                ...
                <span className="font-medium text-sm">Male Students<br/>(Chattogram Metro Only)</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center gap-6 w-full h-full px-4">
          <div className="text-center w-full">
            <h2 className="text-xl md:text-2xl font-bold text-brand-primary mb-2">রেজিস্ট্রেশনের সময় বাকি</h2>
          ...
          <div className="text-gray-600 space-y-2 mt-6 bg-white py-3 px-6 rounded-lg shadow-sm border border-gray-100 w-full text-center">
            <div className="flex items-center justify-center gap-2">
              <svg className="w-5 h-5 text-brand-accent" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd"></path></svg>
              <span>ডেডলাইন: <strong className="text-brand-accent text-lg">১৪ জুন ২০২৬</strong></span>
            </div>
          </div>

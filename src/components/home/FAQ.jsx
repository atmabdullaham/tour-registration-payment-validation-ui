...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
          <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v-1.5A2.25 2.25 0 0 1 6 .75h12a2.25 2.25 0 0 1 2.25 2.25v1.5m-16.5 0h16.5m-16.5 0v11.25A2.25 2.25 0 0 0 6 18h12a2.25 2.25 0 0 0 2.25-2.25V4.5" />
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
          <path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v8.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5v-8.25M12 4.5v16.5m-7.5-7.5h15M12 4.5a3 3 0 1 1 3 3h-3m0-3a3 3 0 1 0-3 3h3" />
        </svg>
      ),
    },
    {
    ...
    <section className="relative py-12 md:py-20 bg-gradient-to-b from-white via-brand-light/20 to-white overflow-hidden">
      ...
      <div className="relative z-10 w-11/12 md:w-10/12 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="inline-flex items-center gap-2 bg-brand-primary/5 text-brand-primary text-xs font-bold px-4 py-1.5 rounded-full mb-4 uppercase tracking-wider">
          ...
          <p className="mt-4 text-gray-500 text-sm md:text-base max-w-xl mx-auto font-medium">
            ইভেন্ট সম্পর্কে আপনার প্রশ্নের উত্তর এখানে পাবেন
          </p>
        </div>
                ...
                >
                  ...
                  <span
                    className={`flex-1 text-sm md:text-base font-bold transition-colors duration-300 ${
                      isOpen ? "text-brand-primary" : "text-slate-700 group-hover:text-brand-primary"
                    }`}
                  >
                    {faq.question}
                  </span>
          ...
          <div className="inline-flex flex-col sm:flex-row items-center gap-3 bg-gradient-to-r from-brand-primary/5 via-brand-light to-brand-secondary/5 rounded-2xl px-6 py-5 border border-brand-primary/10">
            <div className="flex items-center gap-2">
              <div className="p-2 bg-brand-primary/10 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 text-brand-primary">

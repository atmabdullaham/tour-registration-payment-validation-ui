  ...
  const steps = [
    {
      ...
      title: "ফি প্রদান",
      description:
        "বিকাশ/নগদ (01859902430) নাম্বারে ফি প্রদান করে ট্রানজেকশন আইডিটি কপি করে নিন (ফি: ৫০০ টাকা)",
      icon: "💰",
    },
...

    {
      id: 3,
      title: "কনফার্মেশন",
      description: "সাবমিট করার পর আপনার দেওয়া তথ্যাদি যাচাই করে একটি কনফার্মেশন মেসেজ পাঠানো হবে।",
      icon: "✅",
    },
  ];
